  ...
  return (
    <div className='w-full flex flex-col items-center justify-center gap-12 lg:flex-row lg:flex lg:items-center lg:justify-center pt-30 lg:pt-32 mb-12 lg:mb-0 min-h-auto'>
      <div className='w-1/2 items-center justify-center flex flex-col'>
        <iframe className='w-[400px] h-[400px] lg:w-[600px] lg:h-[600px]' src="https://lottie.host/?file=5b7ac62e-94ab-4112-b7bc-fceb7f749171/zOLRL1lXBU.json"></iframe>
      </div>
    <div className='w-1/1 px-0 mx-0 flex flex-col gap-6 items-center'>
    ...
    <div className='text-sm rounded-md bg-[#e83468] text-white py-2 px-6 w-[200px] mt-4 cursor-pointer'>
